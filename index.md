...
Основной язык программирования: **C**. Системные вызовы желательно проверять на корректность выполнения - случае критических ошибок программа должна завершаться с информативным сообщением.
...
- **КБ** (КН, ФТ-3). Для сдачи зачёта автоматом: четыре сделанные вовремя задачи согласно графику. Для допуска к зачёту - две любые задачи.
